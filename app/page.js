...
import { Instagram, TikTok, Youtube, Arrow } from "@/components/Icons/page"
      ...
      <main>
        <div className="w-[85%] h-[35rem] mx-auto">
                <div className="flex flex-col justify-center h-full lg:w-[80%] md:w-[70%] w-[90%] ml-[7%]">
                  ...
                  <Parrafo styles="sm:text-4xl text-xl">
                    ...
                    obtén tu <span className="text-[#FFBD59]">visado</span> en <span className="text-[#FFBD59]">menos de 90 días</span>
                  </Parrafo>
                </div>
        </div>
        <div className="flex flex-col justify-center items-center">
          <div className="mb-8"><Arrow className="w-16 h-16" fill="#fff"/></div></div>
        <OpacityAnimation>
        ...
        <div>
          <div className="sm:w-[60%] mx-auto py-16 w-[85%]">
            <div>
              <OpacityAnimation>
                <Titulo styles="text-white">¿<span className="text-[#FFBD59]">IDIOMA</span>? Не волнуйся</Titulo>
                <Parrafo styles="mt-4 text-xl">
                  <span className="text-[#FFBD59]">¿No entendiste verdad?</span> Tranquilo yo estaba igual al <span className="text-[#FFBD59]">principio </span>
                  y ya pase por ese proceso, es <span className="text-[#FFBD59]">mas sencillo</span> de lo que crees.
                  <span className="text-[#FFBD59]"> Uno de los primeros pasos</span> que realizaremos será en la
                  inscripción de la facultad de idioma, por cierto, no te
                  olvides, tenemos la comunidad <span className="text-[#FFBD59]">ZDOROVO</span> en rusia que hara <span className="text-[#FFBD59]">mas
                  agradable tu experiencia.</span>
                </Parrafo>
              </OpacityAnimation>
            </div>
          </div>
        ...
        <div className="w-[85%] sm:w-[60%] mx-auto"> <div className="sm:w-[80%]"><Titulo styles="text-[#FFBD59]">
